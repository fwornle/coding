...
LayeredIntegrationStructure is explicitly a subcomponent of CodingPatterns, meaning it is one of the enforced patterns that define how this codebase is written and extended. Its influence is visible across at least three integrations: `integrations/code-graph-rag/`, `integrations/semantic-analysis/`, and `integrations/constraint-monitor/`. Any new integration added to the project is expected to replicate this topology.
