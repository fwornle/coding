...
AgentProfileRuntimeConfig is consumed by whatever runtime layer instantiates and operates agents within `integrations/semantic-analysis`. The profile data feeds into model client construction and inference parameter passing, while the capabilities fields presumably gate or annotate what each agent is permitted to do at runtime.
