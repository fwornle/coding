...
* **Sibling – MCP Constraint Monitor** – Enforces integrity constraints before commit, as per `integrations/constraint-monitor/README.md`.  The monitor may register callbacks that EntityPersistence invokes during transaction preparation.
