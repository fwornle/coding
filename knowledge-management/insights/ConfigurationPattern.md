...
*PlantUML source: [ConfigurationPattern_architecture.puml](puml/ConfigurationPattern_architecture.puml)*

### Sequence Diagram
![Sequence Architecture](images/ConfigurationPattern_sequence.png)

*PlantUML source: [ConfigurationPattern_sequence.puml](puml/ConfigurationPattern_sequence.puml)*

### Use-cases Diagram
![Use-cases Architecture](images/ConfigurationPattern_use-cases.png)

*PlantUML source: [ConfigurationPattern_use-cases.puml](puml/ConfigurationPattern_use-cases.puml)*

### Class Diagram
![Class Architecture](images/ConfigurationPattern_class.png)

*PlantUML source: [ConfigurationPattern_class.puml](puml/ConfigurationPattern_class.puml)*
