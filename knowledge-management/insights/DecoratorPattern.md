...
![System Architecture](images/decorator-pattern-architecture.png)
...
![Technical Structure](images/decorator-pattern-class.png)
...
![Process Sequence](images/decorator-pattern-sequence.png)
...
### Use Cases
![Use Cases](images/decorator-pattern-use-cases.png)

### All Diagrams
### Architecture Diagram
![Architecture Architecture](images/decorator-pattern-architecture.png)

*PlantUML source: [decorator-pattern-architecture.puml](puml/decorator-pattern-architecture.puml)*

### Sequence Diagram
![Sequence Architecture](images/decorator-pattern-sequence.png)

*PlantUML source: [decorator-pattern-sequence.puml](puml/decorator-pattern-sequence.puml)*

### Use-cases Diagram
![Use-cases Architecture](images/decorator-pattern-use-cases.png)

*PlantUML source: [decorator-pattern-use-cases.puml](puml/decorator-pattern-use-cases.puml)*

### Class Diagram
![Class Architecture](images/decorator-pattern-class.png)

*PlantUML source: [decorator-pattern-class.puml](puml/decorator-pattern-class.puml)*
