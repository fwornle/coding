...
* **Semantic Analysis Pipeline** – The `semantic-analysis` component calls ServiceManager to ensure the downstream NLP services are up before processing any request.  This dependency is implicit in the observation that ServiceManager is “integrated with the semantic analysis pipeline.”  
