...
- [Knowledge Graph Hierarchical Structure](./graph-hierarchy.md) — the entity classes and relation
  types this view folds along
- [Ontology](./ontology.md) — what each class is allowed to mean
