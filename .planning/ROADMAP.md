...
Plans:
- [ ] 56-01-PLAN.md — Store selection-sync slice + Esc→clearSelection + RED Playwright spec (Wave 1 foundation)
- [ ] 56-02-PLAN.md — History sidebar slice: atomic click write + data-history-id fix + highlight (Wave 2)
- [ ] 56-03-PLAN.md — LSL timeline timestamp scale + tick→atomic Phase 56 fields (Wave 2)
