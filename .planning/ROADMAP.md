...
- [ ] 59-01-PLAN.md — Refactor ObservationWriter.writeInsight to return {legacyId, mintedId} + unit tests (ORPHAN-INS-01 prerequisite)
- [ ] 59-02-PLAN.md — Digest writer-fix: add derivedFrom loop after putEntity in consolidateDay plain-insert branch + unit tests (ORPHAN-DIG-01)
