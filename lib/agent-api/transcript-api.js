...
class TranscriptAdapter {
   ...
   * @param {string} [_projectPath] - Optional project path
   ...
   * @abstract
   */
  async readTranscripts(_options = {}) {
   ...
   * @param {Object} _nativeEntry - Entry in agent-native format
   * @returns {LSLEntry}
   * @abstract
   */
  convertToLSL(_nativeEntry) {
