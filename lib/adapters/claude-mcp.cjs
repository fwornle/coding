// See agent-registry.cjs: require(esm) yields the namespace, so the ESM default
// export has to be unwrapped before it can be extended.
const AgentAdapter = require('../agent-adapter.js').default;
const { executeCommand, fileExists } = require('../utils/system.js');
