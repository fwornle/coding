...
//         AgentRegistry.getAdapter(...) (interactive MCP/HTTP shims) and NOT the
//         interactive MCP launcher wrapper for claude (that boots an interactive MCP
 ...
 * the headless override table (claude → `claude`, NOT the interactive MCP wrapper).
