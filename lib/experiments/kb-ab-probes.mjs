...
import { REFERENCE_SAMPLES, referencePrompt } from './kb-ab-sampler.mjs';
...
export const GEN_PROCESS = 'bg-kb-ab-sampler';
 ...
 */
export async function referenceProbe(insight, goal) {
  const texts = [];
