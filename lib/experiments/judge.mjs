...
const JUDGE_SYSTEM_PROMPT = [
  ...
  '  - a CONFIDENCE CAP from MISSING corroborating evidence — no review or tests ran,',
  '    or file contents are not visible to you — which limits how high you can score,',
  '    and is NOT the same as finding a defect (e.g. "code_quality 0.60: no review',
  '    findings or test summary corroborate it and contents are unseen, so capped',
  '    below 1.0 on low confidence, not for an observed problem").',
