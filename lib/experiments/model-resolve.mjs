 ...
 * @param {'claude'|'opencode'|'copilot'|'pi'} agent
...
export function resolveModelForAgent(agent, ref) {
  ...
  switch (agent) {
    ...
    case 'pi': return dotted;                     // pi accepts dotted ids from models.json
 ...
 */
export function resolveModelForAgents(ref, agents = ['claude', 'copilot', 'opencode', 'pi']) {
  const out = {};
