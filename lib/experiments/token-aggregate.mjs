...
// Phase 78 gap-closure — proxy-routed foreground agents (opencode, pi) have
...
const FOREGROUND_PROXY_PROCESSES = new Set(['opencode', 'pi']);
...
export function isForegroundGroup(group) {
  ...
  // proxy-routed agent (opencode/pi) that stamps its own process name.
