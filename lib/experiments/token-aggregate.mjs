...
const FOREGROUND_USER_HASHES = new Set(['cladpt', 'copadt']); // claude / copilot FILE adapters
...
export function isForegroundGroup(group) {
  ...
  // Foreground via a claude/copilot file-adapter hash, OR a proxy-routed agent
  // (opencode/mastra) that stamps its own process name and has no adapter hash.
