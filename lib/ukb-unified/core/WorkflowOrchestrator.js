 ...
 * for executing workflows via the semantic-analysis.
 *
 * This allows us to:
...
export class WorkflowOrchestrator {
   ...
   */
  async mockIncrementalWorkflow(scope, _options) {
   ...
   */
  async mockFullWorkflow(_options) {
   ...
   */
  async mockWorkflow(workflowName, _parameters) {
