...
export class HealthMonitor {
  ...
  async start() {
    ...
    if (await this.isHealthMonitorRunning()) {
      console.log(`✅ Health monitor already running on port ${this.port}`);
      return;
    }
  ...
  /**
   * Check if health monitor is already running on the port
   */
  async isHealthMonitorRunning() {
    try {
