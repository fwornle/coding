...
const ABSTAIN_PATTERNS = [
  ...
  // "No payment reconciliation service exists in this repository" — the noun phrase sits
  // between "no" and the verb, so the adjacent-noun patterns above miss it entirely.
