...
export function renderMarkdown(report) {
  ...
  if (disagreements.length) {
    ...
    L.push('');
    L.push('`judge_higher` usually means the checklist matcher is too strict (the answer paraphrased a path) — fix the matcher and re-grade offline. `checklist_higher` usually means correct strings were padded into a wrong narrative, which is a real quality signal. A question exceeding 10% disagreement across arms is the question\'s problem, not the arms\'.', '');
  }
