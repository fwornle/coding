...
export class EntityManager {
  ...
  async _determineProjectNode(team) {
    ...
    const projectMappings = {
      'coding': 'Coding',      // shared-memory-coding.json → Coding project
      'ui': null,              // shared-memory-ui.json → DynArch or Timeline (needs semantic analysis)
      'resi': 'Normalisa'      // shared-memory-resi.json → Normalisa project
    };
