 ...
 *
 *   - constraint-monitor (groq-engine.js)
 ...
 * @param {string} [usage.source] - Source identifier for debugging (e.g. 'constraint-monitor').
 *   Free-form: nothing reads it back, so no value is privileged. Records written
 *   before the repo rename carry 'mcp-constraint-monitor:<method>' instead.
