// PATTERN SOURCE: ported VERBATIM from
...
//
// Logic is byte-for-byte identical to the dashboard source — comment block
// updated to mention Phase 45 provenance + the alias-rewrite note (the `@/`
// alias resolves to `src/` in both apps by design, so import paths stay
// untouched).
